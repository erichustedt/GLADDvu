function [Time,Z,Dx] = read_ASCIIDATA(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIME,REAL,IMAG] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [TIME,REAL,IMAG] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Time,Real,Imag] = importfile('S002_1.dat',1, 318);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/05/25 19:55:22
